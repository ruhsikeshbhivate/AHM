...
public class ExtentListnerClass implements ITestListener {
	...
	public void configureReports()
	{
		...
		String reportName = "AHM Test Report" + timestamp + ".html";
		htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "//AHM_Report//" + reportName);
		...
		htmlReporter.config().setReportName("Reports on AHM");
	...
	public void onTestFailure(ITestResult Result)
	{
		...
		String screenShotPath = System.getProperty("user.dir") + "//ScreenshotFile//" + Result.getName() + ".png" ;
